...
PARTS = {
    ...
    'MPU6050体':     (X(12) - 1.3, X(12) + 16.4, Y(4) - 1.7, Y(11) + 1.7, 2.5, 6.0),
    'MPR121体':      (X(2) - 1.3, X(2) + 20.3, Y(9.5) - 15.3, Y(9.5) + 15.3, 2.5, 6.0),
    '母线区':        (X(8) - 0.6, X(11) + 0.6, Y(3) - 0.6, Y(15) + 0.6, 0, 1.0),
    'J2弯针壳(下出)': (X(1) - 1.3, X(5) + 1.3, Y(2) - 9, Y(2) + 1.3, 0, 7.0),
    'J6弯针壳(下出)': (X(7) - 1.3, X(11) + 1.3, Y(2) - 9, Y(2) + 1.3, 0, 7.0),
    'J5弯针壳(下出)': (X(13) - 1.3, X(15) + 1.3, Y(2) - 9, Y(2) + 1.3, 0, 7.0),
    'J4弯针壳(下出)': (X(17) - 1.3, X(18) + 1.3, Y(2) - 9, Y(2) + 1.3, 0, 7.0),
